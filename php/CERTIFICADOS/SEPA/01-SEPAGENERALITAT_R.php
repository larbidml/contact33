...
//create SEGUNDO SQL  statement	
	...
	//form 1
		echo"<div class=\"row  justify-content-center\">\n";
			echo"<form method=\"post\" action=\"page1.php\" class=\"col col-lg-8 text-light bg-success\">\n";
				...
				echo"</div>\n";
				echo"<button type=\"submit\" class=\"btn btn-danger\">page1</button>\n";
