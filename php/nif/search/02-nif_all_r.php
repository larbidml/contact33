            ...
            {              
               echo" <div class=\"container bg-light\">\n";
                  if(isset($data))
                  {
					...
					// //doctypo
					// echo "<div class=\"row\">\n";
					// echo "<div class=\" col-4 col-sm-4 col-md-2   col-lg-2  bg-dark text-white \">Tipo</div>\n";                    
					// echo "<div class=\" col-8 col-sm-8 col-md-10  col-lg-10  \">{$data[$row]["doctypo"]}</div>\n";
					// echo "</div>\n"; 

					//nif
					if(strlen($data[$row][1]) >1 )
					{
						echo "<div class=\"row\">\n";
					...
					if(strlen($data[$row]["SOPORTE"]) >1 )
					{
						...
						echo "<div class=\" col-8 col-sm-8 col-md-10  col-lg-10  \">{$data[$row]["SOPORTE"]}</div>\n";
						echo "</div>\n"; 
					}
					...
					// //GENERO
						...
						// 	{
						// 		echo "<div class=\"row\">\n";
						// 		echo "<div class=\" col-4 col-sm-4 col-md-2   col-lg-2  bg-dark text-white \">GENERO</div>\n";                    
