	...
	else
	{
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col col-lg-10  text-light bg-danger">          
                <br>
                <form method="post" action="03-nif_delete_form.php">
                        <div class="form-group row">          
                            <label class="col-form-label col-sm-2" for="exampleFormControlSelect1">SELECIONAR:</label>
                            <?PHP
