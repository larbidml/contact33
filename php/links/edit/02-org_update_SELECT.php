<?PHP
    ...
    try 
    {
		...
		$sqlQuery = 
					...
					WHERE ORGANISMOnombre LIKE :terminobusqueda 
	...
	else
	{
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <br>
                <form method="post" action="03-org_update_form.php">
                        <div class="form-group row">          
                            ...
                            <?PHP
                                ...
                                for ($row=0; $row < $num_rows ; $row++)
                                    {   
                                        $nombrecompleto = $DATA[$row]["ORGANISMOnombre"];
                                        echo" <option value=\"{$DATA[$row]["ORGANISMOnombre"]}\">{$nombrecompleto}</option>\n";
                                    }
                                echo "</select>\n";
                            ?>
                            <div class="col-sm-1">
