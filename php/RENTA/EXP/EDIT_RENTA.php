...
echo "<form action=\"EDIT-RENTA_R.php\" method=\"post\">\n";

//div1
	echo "<div class=\"form-row bg-info\">\n";
	//id hidden
		echo "<input type=\"hidden\" class=\"form-control\" id=\"inputid\"  name=\"id\" value=\"{$data[0]["id"]}\">\n";
		echo "<input type=\"hidden\" class=\"form-control\" id=\"idrenta\"  name=\"idrenta\" value=\"{$data[0]["idrenta"]}\">\n";
